...
# Usage: Installing dependencies for heat-thermodynamics-virtual-lab
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /heat-thermodynamics-virtual-lab

COPY src/ /heat-thermodynamics-virtual-lab/src

WORKDIR ./heat-thermodynamics-virtual-lab/src
